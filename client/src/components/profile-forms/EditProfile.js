...
const EditProfile = ({
  ...
  //we can use setFormdata
  // make sure that the company part of the formdata
  //if there's no profile company or loading then have a blank field(du vide)
  //sinon fill it (remplis le ) et ainsi de suite
  //the social we make sure there s loading or theres an object to social then else we whow twitter
  useEffect(() => {
    getCurrentProfile();
   setFormData({
      ...
      githubusername:
        loading || !profile.githubusername ? '' : profile.compagithubusernameny,
